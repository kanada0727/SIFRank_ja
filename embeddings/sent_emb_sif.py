...
class SentEmbeddings:
    ...
    def __init__(self, word_embeddor, weightfile_pretrain='/content/drive/My Drive/SIFRank_ja/auxiliary_data/corpus_vocab.txt',
                 weightfile_finetune='/content/drive/My Drive/SIFRank_ja/auxiliary_data/inspec_vocab.txt', weightpara_pretrain=2.7e-4, weightpara_finetune=2.7e-4,
                 lamda=1.0, database="", embeddings_type="elmo"):

        weightfile_pretrain = '/content/drive/My Drive/SIFRank_ja/auxiliary_data/corpus_vocab.txt'

        if (database == "Inspec"):
            weightfile_finetune = '/content/drive/My Drive/SIFRank_ja/auxiliary_data/inspec_vocab.txt'
        elif (database == "Duc2001"):
            weightfile_finetune = '/content/drive/My Drive/SIFRank_ja/auxiliary_data/duc2001_vocab.txt'
        elif (database == "SemEval2017"):
            weightfile_finetune = '/content/drive/My Drive/SIFRank_ja/auxiliary_data/semeval_vocab.txt'
        else:
            weightfile_finetune = '/content/drive/My Drive/SIFRank_ja/auxiliary_data/corpus_vocab.txt'
